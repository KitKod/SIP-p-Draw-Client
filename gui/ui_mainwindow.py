...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addFile(u"../resources/open.png", QSize(), QIcon.Normal, QIcon.Off)
        self.action_open.setIcon(icon)
        self.action_save = QAction(MainWindow)
        self.action_save.setObjectName(u"action_save")
        icon1 = QIcon()
        icon1.addFile(u"../resources/save.png", QSize(), QIcon.Normal, QIcon.Off)
        self.action_save.setIcon(icon1)
        self.action_run = QAction(MainWindow)
        self.action_run.setObjectName(u"action_run")
        icon2 = QIcon()
        icon2.addFile(u"../resources/run_scenario.png", QSize(), QIcon.Normal, QIcon.Off)
        self.action_run.setIcon(icon2)
        self.action_new_scenario = QAction(MainWindow)
        self.action_new_scenario.setObjectName(u"action_new_scenario")
        icon3 = QIcon()
        icon3.addFile(u"../resources/new_file.png", QSize(), QIcon.Normal, QIcon.Off)
        self.action_new_scenario.setIcon(icon3)
        ...
        self.page_spec_attr.setGeometry(QRect(0, 0, 388, 413))
        ...
        self.scrollAreaWidgetContents_3.setGeometry(QRect(0, 0, 368, 393))
        ...
        self.scrollAreaWidgetContents_4.setGeometry(QRect(0, 0, 368, 393))
        ...
        self.menufile.addAction(self.action_new_scenario)
        self.menufile.addAction(self.action_open)
        self.menufile.addAction(self.action_save)
        self.menuRun.addAction(self.action_run)
        self.toolBar.addAction(self.action_new_scenario)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_open.setToolTip(QCoreApplication.translate("MainWindow", u"Open scenarion", None))
#endif // QT_CONFIG(tooltip)
        self.action_save.setText(QCoreApplication.translate("MainWindow", u"Save", None))
#if QT_CONFIG(tooltip)
        self.action_save.setToolTip(QCoreApplication.translate("MainWindow", u"Save scenario to file ", None))
#endif // QT_CONFIG(tooltip)
        self.action_run.setText(QCoreApplication.translate("MainWindow", u"Run", None))
        self.action_new_scenario.setText(QCoreApplication.translate("MainWindow", u"New Scenario", None))
#if QT_CONFIG(tooltip)
